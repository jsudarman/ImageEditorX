...
@property (nonatomic, retain) NSString *includeStatistics;
@property (nonatomic, retain) NSString *firstSettlementDate;
@property (nonatomic, retain) NSString *lastSettlementDate;
